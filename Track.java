...
class Track {
    ...
    private String formattedDuration(int totalSeconds) {
        ...
        int secounds = totalSeconds%60;
        if(secounds >9)
        {
            String totalMinutes = Integer.toString(minutes) + ":" + Integer.toString(secounds);
            return totalMinutes;
        }
        String totalMinutes = Integer.toString(minutes) + ":0" + Integer.toString(secounds);
        return totalMinutes;
    }
}